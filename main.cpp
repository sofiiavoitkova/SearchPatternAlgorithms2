...
int main() {
    ...
    for (int power = 1; power <= textWords.size(); power *= 10) {
        for (int d = 1; d < 10; d++) {
            ...
            //std::cout << size << " " << naiveBuildTime/ T << " " << BBSTBuildTime/ T << " " << trieBuildTime/ T << " " << hashBuildTime/ T << std::endl;
...
//    std::vector<std::string> naiveDictionary;
//
//    std::vector<long long> sizes, naiveTimes, BBSTTimes, trieTimes, hashTimes;
//
//    std::string dictionaryFile = "C:\\Users\\serwis\\CLionProjects\\un2\\words.txt";
//    std::string textFile = "C:\\Users\\serwis\\CLionProjects\\un2\\pattern.txt";
//    std::cout << "size naive_build BBST_build trie_build hash_build naive_search BBST_search trie_search hash_search" << std::endl;
...
//            naiveTimes.push_back(naiveBuildTime);
//            BBSTTimes.push_back(BBSTBuildTime);
//            trieTimes.push_back(trieBuildTime);
//            hashTimes.push_back(hashBuildTime);
//
//            std::cout << size << " "
//                      << naiveBuildTime << " "
//                      << BBSTBuildTime << " "
//                      << trieBuildTime << " "
//                      << hashBuildTime << std::endl;
//        }
//    }
//
//    long long totalNaive = std::accumulate(naiveTimes.begin(), naiveTimes.end(), 0LL);
//    long long totalBBST = std::accumulate(BBSTTimes.begin(), BBSTTimes.end(), 0LL);
//    long long totalTrie = std::accumulate(trieTimes.begin(), trieTimes.end(), 0LL);
//    long long totalHash = std::accumulate(hashTimes.begin(), hashTimes.end(), 0LL);
//
